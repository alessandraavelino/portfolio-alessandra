...
function Skills() {
  return (
    <div>
      <section className="text-gray-600 bg-gray-700 body-font" id="skills">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="text-4xl font-bold title-font mb-4 text-white">
              Skills 
            </h1>
            <p className="lg:w-2/3 mx-auto text-white text-base">
                Over 3 years in the world of technology, I gained skills in the following technologies
            </p>
          </div>
          <div className="flex flex-wrap -m-2">
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-purple-600 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white text-xl title-font font-bold">
            ...
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
              <div className="h-full flex items-center border-purple-600 border p-4 rounded-lg">
                ...
                <div className="flex-grow">
                  <h2 className="text-white text-xl title-font font-bold">Python</h2>
                </div>
              </div>
            </div>
            <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
